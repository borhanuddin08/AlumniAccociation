                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select" name="visibility">
                                    ...
                                    <?php if (!empty($user['batch']) && $user['role'] === 'alumni'): ?>
                        ...
                        <div class="post-card" id="post-<?php echo $post['id']; ?>">
                            ...
                            <div class="post-header">
                                ...
                                <div class="post-author">
                                    ...
                                    <div class="post-time">
                                        <?php 
                                        $visIcon = match($post['visibility']) {
                                            'batch' => '<i class="fas fa-users" title="Batch Only"></i>',
                                            'department' => '<i class="fas fa-building" title="Department Only"></i>',
                                            default => '<i class="fas fa-globe" title="Public"></i>'
                                        };
                                        echo $visIcon;
                                        ?>
