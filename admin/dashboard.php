...
// Get statistics
$totalAlumni = $db->query("SELECT COUNT(*) as count FROM users WHERE status = 'active' AND role = 'alumni'")->fetch_assoc()['count'];
$totalStudents = $db->query("SELECT COUNT(*) as count FROM users WHERE status = 'active' AND role = 'student'")->fetch_assoc()['count'];
$pendingAlumni = $db->query("SELECT COUNT(*) as count FROM users WHERE status = 'pending' AND role = 'alumni'")->fetch_assoc()['count'];
$pendingStudents = $db->query("SELECT COUNT(*) as count FROM users WHERE status = 'pending' AND role = 'student'")->fetch_assoc()['count'];
        ...
        <div class="col-md-6 col-lg-4 col-xl-2">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo SITE_URL; ?>/admin/students.php" class="btn btn-sm btn-outline-primary mt-2">View</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-2">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="stat-label">Pending Alumni</div>
        ...
        <div class="col-md-6 col-lg-4 col-xl-2">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo SITE_URL; ?>/admin/students.php?status=pending" class="btn btn-sm btn-outline-primary mt-2">Review</a>
                </div>
            </div>
        </div>
